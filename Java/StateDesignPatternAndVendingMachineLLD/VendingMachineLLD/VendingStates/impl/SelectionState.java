package StateDesignPatternAndVendingMachineLLD.VendingMachineLLD.VendingStates.impl;
import StateDesignPatternAndVendingMachineLLD.VendingMachineLLD.VendingStates.State;
...
public class SelectionState implements State{
    ...
    public List<Coin> refundFullMoney(VendingMachine machine) throws Exception{
        ...
        machine.setVendingMachineState(new IdleState(machine));//by passing machine in idle state the coin list will be empty again
