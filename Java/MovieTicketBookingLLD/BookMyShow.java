...
import MovieTicketBookingLLD.Enums.*;
...
public class BookMyShow {
    //declaring this here due to silly fucking error
    ...
    private void createBooking(City userCity, String movieName){
        //1. search the movie by my location
        List<Movie> movies=movieController.getMoviesByCity(userCity);
        //2 . Select movie you want to see
        ...
        //3. get all shows of this movie in Bangalore location
